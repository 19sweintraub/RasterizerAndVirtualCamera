...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_8 : rasterizer.cam.moveF(0.5); break; // move forward
    case Qt::Key_2 : rasterizer.cam.moveF(-0.5); break; // move backward
    case Qt::Key_4 : rasterizer.cam.moveR(-0.5); break; // move left
    case Qt::Key_6 : rasterizer.cam.moveR(0.5); break; // move right
    case Qt::Key_9 : rasterizer.cam.moveU(0.5); break; // move up
    case Qt::Key_7 : rasterizer.cam.moveU(-0.5); break; // move right

    // rotate
    case Qt::Key_Right : rasterizer.cam.rotCamU(5); break;
    case Qt::Key_Left : rasterizer.cam.rotCamU(-5); break;
    case Qt::Key_Up : rasterizer.cam.rotCamR(-5); break;
    case Qt::Key_Down : rasterizer.cam.rotCamR(5); break;
    case Qt::Key_3 : rasterizer.cam.rotCamF(5); break;
    case Qt::Key_1 : rasterizer.cam.rotCamF(-5); break;
    }
...
void MainWindow::on_actionLoad_Scene_triggered()
{
    ...
    for(int i = 0; i < objects.size(); i++)
    {
        ...
        else if(QString::compare(type, QString("obj")) == 0)
        {
            ...
            {
                p.SetNormalMap(new QImage(local_path.toString().append(obj["normalMap"].toString())));
            }
            polygons.push_back(p);
        }
    }
